...
const CurrencyList = ({register}) => {
  return (
    <div className='overflow-y-hidden bg-white'>
      <select {...register('currency')} id="currencyList"  onFocus={(e) => { e.target.size = 5;}}
   onBlur={(e) => { e.target.size = 1; }} onChange={(e) => {e.targetsize=1}} className='w-full [&>*]:text-[#9ca3af]'>
